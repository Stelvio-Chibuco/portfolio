...
const workExperiences = {
  ...
  experience: [
    {
      role: "Técnico Superior De Informática",
      company: "UniSave",
  ...
  projects: [
    {
      ...
      footerLink: [
        {
          name: "Visit Website",
          url: "https://cyber-gorilla.blogspot.com/"
        }
    ...
    },
    {
      ...
      footerLink: [
        {
          name: "Visit Website",
          url: "https://www.youtube.com/channel/UCxEz1GMdhTEaHxKuHVQU0Sg"
        }
      ]
    }
  ],
...
const achievementSection = {
  ...
  achievementsCards: [
    {
      title: "Introducao a Cibersegurança ",
      subtitle:
        "",
  ...
  blogs: [
    {
      ...
      title: "Instalação do Servidor Ubuntu 20.04 e Instalação da interface gráfica no servidor Ubuntu step-by-step",
      description:
...
const contactInfo = {
  ...
  subtitle:
    "Quer discutir um projeto ou apenas dizer cumprimentar? Meu WhatsApp está aberto para todos.",
